...
public class PruebaArbolGenerico {
	...
	protected static void pruebaInsertar() {
		...
		assert ag.insertar('a', null)
			 : "Debe insertar 'a' como raíz del árbol";
		assert ag.insertar('b', 'a')
			 : "Debe insertar 'b' como hijo de 'a'";
		assert ag.insertar('c', 'a')
			 : "Debe insertar 'c' como hijo de 'a'";
		assert ag.insertar('d', 'b')
		 	 : "Debe insertar 'd' como hijo de 'b'";
		assert ag.insertar('e', 'c')
			 : "Debe insertar 'd' como hijo de 'b'";
		assert ag.insertar('f', 'c')
			 : "Debe insertar 'd' como hijo de 'b'";
		assert ag.insertar('h', 'g') == false
			 : "No debe insertar 'h' (padre 'g' inexistente)";
	}
	...
	protected static void pruebaPertenece() {
		...
		ag.insertar('b', 'a');
		ag.insertar('c', 'a');
		assert ag.pertenece('c')
			 : "'c' debe pertenecer al árbol";
		assert ag.pertenece('d') == false
			 : "'d' no debe pertenecer al árbol";
	}
	...
	protected static void pruebaNivel() {
		ArbolGenerico<Character> ag = crearArbolPrueba();
		assert ag.nivel('a') == 0
			 : "Nivel de 'a' debe ser 0";
		assert ag.nivel('b') == 1
			 : "Nivel de 'b' debe ser 1";
		assert ag.nivel('g') == 2
			 : "Nivel de 'g' debe ser 2";
		assert ag.nivel('k') == 3
			 : "Nivel de 'k' debe ser 3";
		assert ag.nivel('m') == 4
			 : "Nivel de 'm' debe ser 4";
	}
	
	protected static void pruebaPadre() {
		ArbolGenerico<Character> ag = crearArbolPrueba();
		assert ag.padre('a') == null
			 : "Padre de 'a' debe ser nulo";
		assert ag.padre('b') == 'a'
			 : "Padre de 'b' debe ser 1";
		assert ag.padre('g') == 'c'
			 : "Padre de 'g' debe ser 2";
		assert ag.padre('k') == 'h'
			 : "Padre de 'k' debe ser 3";
		assert ag.padre('m') == 'l'
			 : "Padre de 'm' debe ser 4";
	}
	...
	protected static void pruebaAncestros() {
		...
		assert ag.ancestros('f').toString().equals("[b a]")
			 : "Los ancestros de 'f' deben ser: c a";
		assert ag.ancestros('m').toString().equals("[l h d a]")
			 : "Los ancestros de 'm' deben ser: l h d a";
	}
	
	protected static void pruebaListarPreorden() {
		ArbolGenerico<Character> ag = crearArbolPrueba();
		assert ag.listarPreorden()
				 .toString()
