...
public class TestTP1 {
	...
	public static void pruebaGenerarCola() {
		...
		assert generarCola(s, 5).toString().replaceAll(r, "")
			.equals("4321098765");
		assert generarCola(s, 1).toString().replaceAll(r, "")
			.equals(s);
	...
	/**
	 * Genera una cola de enteros a partir de una cadena (sólo dígitos).
	 * Si la cadena contiene algún carácter que no sea un dígito, devuelve una
	 * cola vacía.
	 * 
	 * @param cadena
	 * @param x
